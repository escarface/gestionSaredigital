...
const AppLayout: React.FC = () => {
  ...
  return (
    <div className="bg-background-light text-text-main font-display antialiased h-screen overflow-hidden flex selection:bg-primary/30">
      ...
      <div className={`fixed inset-y-0 left-0 z-30 transform transition-transform duration-300 md:relative md:transform-none ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <Sidebar 
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded-full ${
                  user.role === 'Admin' ? 'bg-primary text-black' : 
